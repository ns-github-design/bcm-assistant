...
|-------|-------------|--------|
| 1.1 | Define scope, target resource types, and Pilot Light strategy | To Do |
| 1.2 | Design architecture (React + FastAPI + Copilot SDK + CLI) | To Do |
| 1.3 | Design UI — agent transparency feed, dark enterprise theme | To Do |
| 1.4 | Scaffold backend and frontend projects | To Do |
...
| Story | Description | Status |
|-------|-------------|--------|
| 2.1 | Build 4 custom tools with `@define_tool` (Azure discovery, budget, CMDB, DR plan) | To Do |
| 2.2 | Create mock data — Trading Platform subscription (23 resources) | To Do |
| 2.3 | Wire agent with system prompt embedding Pilot Light DR knowledge | To Do |
| 2.4 | Stream agent events (tool calls, thinking, responses) via SSE | To Do |
...
| Story | Description | Status |
|-------|-------------|--------|
| 3.1 | Build subscription input screen and split-panel layout | To Do |
| 3.2 | Build Agent Activity Feed — real-time timeline with expand/collapse | To Do |
...
| Story | Description | Status |
|-------|-------------|--------|
| 4.1 | Build rule-based strategy engine (per-service, tier-adjusted) | To Do |
